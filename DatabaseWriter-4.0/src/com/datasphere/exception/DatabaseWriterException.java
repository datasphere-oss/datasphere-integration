...
public class DatabaseWriterException extends TransactionManagerException
{
    private Error errorCode;
    private static final long serialVersionUID = 6364524889611350696L;
    
    public DatabaseWriterException(final String msg) {
        super(msg, (Exception)null);
    }
    
    public DatabaseWriterException(final String msg, final Exception exp) {
        super(msg, exp);
    }
    
    public DatabaseWriterException(final Error errCode, final String msg, final Exception exp) {
        super(errCode.toString() + "  " + msg, exp);
        this.errorCode = errCode;
    }
    
    public DatabaseWriterException(final Error errCode, final String msg) {
        super(errCode.toString() + "  " + msg);
        this.errorCode = errCode;
        this.setErrorMessage(errCode.toString() + "  " + msg);
        this.setComponentName("DatabaseWriter");
    ...
    public DatabaseWriterException(final com.datasphere.common.errors.Error errCode, final String msg) {
        super(errCode.toString() + "  " + msg);
