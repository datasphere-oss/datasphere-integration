...
public class RevokePermissionFromStmt extends Stmt implements SecurityStmt
{
    ...
    public RevokePermissionFromStmt(@NotNull final List<ObjectPermission.Action> listOfPrivilege, @Nullable final List<ObjectPermission.ObjectType> objectType, @NotNull final String name, @Nullable final String userorpermissionname, final EntityType what) {
        this.towhat = what;
    ...
    public Object compile(final Compiler c) throws MetaDataRepositoryException {
        return c.RevokePermissionFromStmt(this);
    }
