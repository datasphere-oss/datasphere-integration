...
@XmlType(name = "id", propOrder = { "column", "field", "index", "cacheIndex", "generatedValue", "temporal", "enumerated", "convert", "converter", "typeConverter", "objectTypeConverter", "structConverter", "tableGenerator", "sequenceGenerator", "uuidGenerator", "property", "accessMethods" })
public class Id
{
