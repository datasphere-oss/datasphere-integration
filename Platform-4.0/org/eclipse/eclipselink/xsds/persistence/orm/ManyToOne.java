...
@XmlType(name = "many-to-one", propOrder = { "joinColumn", "joinTable", "joinField", "cascade", "joinFetch", "batchFetch", "property", "accessMethods", "noncacheable", "partitioning", "replicationPartitioning", "roundRobinPartitioning", "pinnedPartitioning", "rangePartitioning", "valuePartitioning", "hashPartitioning", "unionPartitioning", "partitioned" })
