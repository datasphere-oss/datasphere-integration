...
@XmlType(name = "many-to-many", propOrder = { "orderBy", "orderColumn", "mapKey", "mapKeyClass", "mapKeyTemporal", "mapKeyEnumerated", "mapKeyConvert", "mapKeyAttributeOverride", "mapKeyAssociationOverride", "mapKeyColumn", "mapKeyJoinColumn", "converter", "typeConverter", "objectTypeConverter", "structConverter", "joinTable", "joinField", "cascade", "cascadeOnDelete", "joinFetch", "batchFetch", "property", "accessMethods", "noncacheable", "partitioning", "replicationPartitioning", "roundRobinPartitioning", "pinnedPartitioning", "rangePartitioning", "valuePartitioning", "hashPartitioning", "unionPartitioning", "partitioned" })
