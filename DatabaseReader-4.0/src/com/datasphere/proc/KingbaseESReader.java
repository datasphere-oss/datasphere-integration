...
@PropertyTemplate(name = "KingbaseESReader", type = AdapterType.source, properties = {
		...
		@PropertyTemplateProperty(name = "ConnectionURL", type = String.class, required = true, defaultValue = "jdbc:kingbase://127.0.0.1:54322/testdb"),
...
public class KingbaseESReader extends DatabaseReader_1_0 {
